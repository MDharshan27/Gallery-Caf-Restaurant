    ...
    <div class="dashboard">
        ...
        <nav class="sidebar">
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item dropdown">
                    <a href="javascript:void(0);" class="dropdown-btn"><i class='bx bxs-cart-alt'></i> Orders
                        <i class="fas fa-chevron-down dropdown-icon"></i>
                    </a>
                    <ul class="dropdown-list">
...
<script>
  ...
  document.getElementById('confirm-btn').onclick = function() {
      displayMessage('Booking Confirmed!', 'Table booking has been confirmed.', 'success');
    }

    document.getElementById('delete-btn').onclick = function() {
      displayMessage('Booking Deleted!', 'Table booking has been deleted.', 'error');
    }
