...
if (isset($_POST['add_food'])) {
    ...
    $target_dir = "Images/Dinner/";
    $target_file = $target_dir . basename($image);
    move_uploaded_file($_FILES['image']['tmp_name'], $target_file);
    
    // Insert query
    $sql = "INSERT INTO dinner_menu (name, description, price, image) VALUES ('$name', '$description', '$price', '$image')";
...
if (isset($_POST['delete_food'])) {
    $id = $_POST['id'];
    $sql = "DELETE FROM dinner_menu WHERE id='$id'";
...
$menu_items = $conn->query("SELECT * FROM dinner_menu ORDER BY id ASC");
    ...
    <div class="main-content">
      ...
      <div class="breakfast-container">
          <?php while ($row = $menu_items->fetch_assoc()) { ?>
              <div class="menu-card">
                  <img src="Images/Dinner/<?php echo $row['image']; ?>" alt="<?php echo $row['name']; ?>">
  ...
  <script>
    ...
    function hideMessageBox() {
      ...
      function editItem(id, name, description, price, image) {
        ...
        document.getElementById('thumbnailImage').src = 'Images/Dinner/' + image;
