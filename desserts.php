...
<head>
    ...
    <title>Gallery Cafe Restaurant - Desserts</title>
...
<section class="food-menu">
    <div class="container-f">
        <h2>Find our</h2>
        <h1>Most Popular Dessert Items</h1>
    </div>
    ...
    <?php
        ...
        <div class="menu-content breakfast">
            <?php while ($item = $menu_items->fetch_assoc()) { ?>
                <div class="menu-card">
                    <img src="Images/Desserts/<?php echo $item['image']; ?>" alt="<?php echo $item['name']; ?>">
                    ...
                    <div class="menu-card-price">
                        ...
                        <button onclick="addToCart('<?php echo $item['name']; ?>', <?php echo $item['price']; ?>, 'Images/Desserts/<?php echo $item['image']; ?>')">Add to Cart</button>
                    </div>
                </div>
            <?php } ?>
        </div>
