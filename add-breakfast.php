...
if (isset($_POST['add_food'])) {
    ...
    $target_dir = "Images/Breakfast/";
    $target_file = $target_dir . basename($image);
    move_uploaded_file($_FILES['image']['tmp_name'], $target_file);
    
    // Insert query
    $sql = "INSERT INTO breakfast_menu (name, description, price, image) VALUES ('$name', '$description', '$price', '$image')";
...
$menu_items = $conn->query("SELECT * FROM breakfast_menu ORDER BY id ASC");
...
<body>
    ...
    <div class="main-content">
      ...
      <div class="breakfast-container">
          <?php while ($row = $menu_items->fetch_assoc()) { ?>
              <div class="menu-card">
                  <img src="Images/Breakfast/<?php echo $row['image']; ?>" alt="<?php echo $row['name']; ?>">
  ...
  <script>
    ...
    // Optional JavaScript for thumbnail preview
    document.getElementById('foodImage').onchange = function (event) {
    ...
    function hideMessageBox() {
      ...
      function editItem(id, name, description, price, image) {
        ...
        document.getElementById('thumbnail').style.display = 'block';
        document.getElementById('thumbnailImage').src = 'Images/Breakfast/' + image;
