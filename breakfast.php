...
<head>
    ...
    <title>Gallery Cafe Restaurant - Breakfast</title>
...
<section class="food-menu">
    <div class="container-f">
        <h2>Find our</h2>
        <h1>Most Popular Breakfast Items</h1>
    </div>
    ...
    <div class="menu-container">
        ...
        <div class="menu-content breakfast">
            <?php while ($item = $menu_items->fetch_assoc()) { ?>
                <div class="menu-card">
                    <img src="Images/Breakfast/<?php echo $item['image']; ?>" alt="<?php echo $item['name']; ?>">
                    ...
                    <div class="menu-card-price">
                        ...
                        <button onclick="addToCart('<?php echo $item['name']; ?>', <?php echo $item['price']; ?>, 'Images/Breakfast/<?php echo $item['image']; ?>')">Add to Cart</button>
                    </div>
                </div>
            <?php } ?>
        </div>
