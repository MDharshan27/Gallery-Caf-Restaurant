...
<body>
    ...
    <section class="event-details">
        <div class="event-hero">
            ...
            <img src="Images/freedrink.jpg" alt="Event Image" class="event-image">
            <div class="event-info">
                <h1>Enjoy a Free Drink!</h1>
                <h2 class="event-description">
                    Who doesn’t love a free drink? Join us for a limited-time offer and enjoy a complimentary beverage with your meal! Whether you’re in the mood for a refreshing cocktail, a glass of fine wine, or a non-alcoholic favorite, we’ve got you covered. This is our way of saying thanks for choosing Gallary Cafe, where every visit is special. Grab your friends and head over to indulge in this exciting offer – raise your glass and toast to good times!</h2>
                <!-- Countdown Timer -->
                <div class="countdown">
                    <div>
