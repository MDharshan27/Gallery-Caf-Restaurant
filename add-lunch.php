...
if (isset($_POST['add_food'])) {
    ...
    $target_dir = "Images/Lunch/";
    $target_file = $target_dir . basename($image);
    move_uploaded_file($_FILES['image']['tmp_name'], $target_file);
    
    // Insert query
    $sql = "INSERT INTO lunch_menu (name, description, price, image) VALUES ('$name', '$description', '$price', '$image')";
...
if (isset($_POST['delete_food'])) {
    $id = $_POST['id'];
    $sql = "DELETE FROM lunch_menu WHERE id='$id'";
    ...
    <div class="main-content">
      ...
      <div class="breakfast-container">
          <?php while ($row = $menu_items->fetch_assoc()) { ?>
              <div class="menu-card">
                  <img src="Images/Lunch/<?php echo $row['image']; ?>" alt="<?php echo $row['name']; ?>">
  ...
  <script>
    ...
    function hideMessageBox() {
      ...
      function editItem(id, name, description, price, image) {
        ...
        document.getElementById('thumbnailImage').src = 'Images/Lunch/' + image;
