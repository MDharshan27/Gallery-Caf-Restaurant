...
<body>
    ...
    <section class="event-details">
        <div class="event-hero">
            ...
            <img src="Images/party.jpg" alt="Event Image" class="event-image">
            <div class="event-info">
                <h1>Win a Free Party for 6</h1>
                <h2 class="event-description">
                    Get ready to celebrate in style with our "Win a Free Party for 6" event! Imagine an exclusive party for you and 5 friends, complete with a gourmet menu, handcrafted cocktails, and a vibrant atmosphere. This is your chance to enjoy an unforgettable evening, courtesy of Gallary Cafe. Whether you're marking a special occasion or just want to gather with friends, this party will be filled with fun, laughter, and delectable treats. Enter today for your chance to win – the party of a lifetime could be yours!
                </h2>
