...
<body>
    ...
    <section class="event-details">
        <div class="event-hero">
            ...
            <img src="Images/Pairings.jpg" alt="Event Image" class="event-image">
            <div class="event-info">
                <h1>Perfect Food & Wine Pairings!</h1>
                <h2 class="event-description">
                    Experience an extraordinary culinary journey with our expertly curated food and wine pairings. Our chefs have meticulously selected dishes that harmonize with the finest wines, enhancing the flavors of both. Whether you're a seasoned wine enthusiast or new to pairings, this event promises to elevate your palate with perfect combinations of taste and texture. Join us for a dining experience that blends fine cuisine with exquisite wine selections for an unforgettable evening.</h2>
                <!-- Countdown Timer -->
                <div class="countdown">
                    <div>
